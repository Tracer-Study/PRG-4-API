...
{
    public class jawabankuesionerModel
    {
        ...
        public string deskripsiJawaban { get; set; }
        ...
        [MaxLength(100, ErrorMessage = "Jawaban maksimal 100 karakter.")]
        public string nilaiJawaban { get; set; }

        [Required(ErrorMessage = "Textbox wajib diisi.")]
        [MaxLength(10, ErrorMessage = "Textbox maksimal 10 karakter.")]
